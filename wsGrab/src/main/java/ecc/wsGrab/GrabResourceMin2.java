...
@Path("grabdata")
public class GrabResourceMin2 {
	//Declaración de Classes
	...
	//Constructor
	public GrabResourceMin2() {
		srvGrab = new GrabService(gParams);
	}
	...
	public Response getUris(@PathParam("connid") String connID) {
