...
public class putDataEtlMatch {
    ...
    public static void main(String args[]) throws IOException {
        ...
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlSourceField"),Bytes.toBytes("InteractionIDKey"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlDestField"),Bytes.toBytes("InteractionIDKey"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlSourceDateType"),Bytes.toBytes("VARCHAR"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlDestDataType"),Bytes.toBytes("VARCHAR"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlSourceLength"),Bytes.toBytes("18"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlDestLength"),Bytes.toBytes("18"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlSourceReadType"),Bytes.toBytes("F"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlOrder"),Bytes.toBytes("00001"));
        p.add(Bytes.toBytes("match"), Bytes.toBytes("etlActive"),Bytes.toBytes("1"));
